...
public class Update_Delete {
	...
	public static void updateRecord() throws SQLException {
		...
		String updateTableQuery = "UPDATE MAHASISWA SET nama_mhs = 'Muhammad wahyu n' WHERE id_mhs = '2'";
		...
		try {
			...
			System.out.println(recordCount + " record telah berhasil diupdate pada tabel MAHASISWA!");	
		}
